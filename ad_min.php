                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="admin_login_submit.php" method="post">
                                <div class="row">     
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="password"  name="pass_word" class="form-control" id="password2" placeholder="Conform password">
                                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <div class="cart-btn mt-50">
                                ...
                                <a href="admin_signup.php" style="font-size: 15px; color: blue;">Create Account</a>
                            </div>
                        </div>
                    </div>
